/*
	...
	(Since Application.dataPath returns a URL for webplayers, you may must use the WWW class)
...
public class PluginJamomaUnity : MonoBehaviour {
	...
	{
		string eventName = Marshal.PtrToStringAuto (GetEventName ());
		string eventStatus = Marshal.PtrToStringAuto (GetEventStatus ());
	...
	/** Create a parameter data (type "integer" or "decimal") at an address (without the callback function in Unity)
     ...
     @return 0: Cannot create the parameter data at this address
     @return 1: Create successfully the parameter data at this address */
	/*	public static int CreateNumberParameterData(string paramaterAddress, string type, float rangeBoundMin, float rangeBoundMax, string rangeClipmode, string rampDrive, string description)
	{
...
*/
	...
	/** Create a parameter data (type "integer" or "decimal") at an address (with the callback function in Unity)
     ...
     @return 0: Cannot create the parameter data at this address
     @return 1: Create successfully the parameter data at this address */
	/*	public static int CreateNumberParameterDataWithCallbackUnity(string paramaterAddress, string type, float rangeBoundMin, float rangeBoundMax, string rangeClipmode, string rampDrive, string description, [MarshalAs(UnmanagedType.FunctionPtr)] ValueCallback callbackPointer)
	{
		if (IsAddressDeclared(paramaterAddress))
		{
			return -1;
...
*/
	...
	/** Create a parameter data (type "boolean") at an address (without the callback function in Unity)
     ...
     @return 0: Cannot create the parameter data at this address
     @return 1: Create successfully the parameter data at this address */
	/*	public static int CreateBooleanParameterData(string paramaterAddress, string rangeClipmode, string rampDrive, string description)
	{
		if (IsAddressDeclared(paramaterAddress))
		{
			return -1;
...
*/
	...
	/** Create a parameter data (type "boolean") at an address (with the callback function in Unity)
     ...
     @return 0: Cannot create the parameter data at this address
     @return 1: Create successfully the parameter data at this address */
	/*	public static int CreateBooleanParameterDataWithCallbackUnity(string paramaterAddress, string rangeClipmode, string rampDrive, string description, [MarshalAs(UnmanagedType.FunctionPtr)] ValueCallback callbackPointer)
	{
		if (IsAddressDeclared(paramaterAddress))
		{
			return -1;
...
*/
	...
	/** Create a parameter data (type "string") at an address (without the callback function in Unity)
     ...
     @return 0: Cannot create the parameter data at this address
     @return 1: Create successfully the parameter data at this address */
	/*	public static int CreateStringParameterData(string paramaterAddress, string rangeClipmode, string rampDrive, string description)
	{
		if (IsAddressDeclared(paramaterAddress))
		{
			return -1;
...
*/
	...
	/** Create a parameter data (type "string") at an address (with the callback function in Unity)
     ...
     @return 0: Cannot create the parameter data at this address
     @return 1: Create successfully the parameter data at this address */
	/*	public static int CreateStringParameterDataWithCallbackUnity(string paramaterAddress, string rangeClipmode, string rampDrive, string description, [MarshalAs(UnmanagedType.FunctionPtr)] ValueCallback callbackPointer)
	{
		if (IsAddressDeclared(paramaterAddress))
		{
			return -1;
...
/*
	...
	/** Create a return data at an address (with the callback function in Unity)
     ...
     @return 0: Cannot create the return data at this address
     @return 1: Create successfully the return data at this address */
	/*	public static int CreateReturnDataWithCallbackUnity(string returnAddress, string type, string description, [MarshalAs(UnmanagedType.FunctionPtr)] ValueCallback callbackPointer)
	{	
		if (IsAddressDeclared(returnAddress))
		{
			return -1;
...
*/
	...
	{
		string jamomaModularFolderPath = Application.dataPath + "/Plugins/PluginJamomaUnity.bundle/Contents/Resources/jamoma";
